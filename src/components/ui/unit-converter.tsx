...
export default function UnitConverterComponent() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-tr from-orange-500 to-orange-800 dark:bg-orange-500">
       
      {/* Center the unit converter card within the screen */}
      <div className="max-w-md w-full p-6 h-full bg-card rounded-full shadow-lg shadow-slate-800 text-center font-sans">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Button
            type="button"
            className="col-span-2 bg-orange-500 text-primary-foreground hover:bg-primary/40 border-2 border-pink-800 items-centerfocus-visible:ring-1 focus-visible:ring-ring"
